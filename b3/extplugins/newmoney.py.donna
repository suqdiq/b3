...
class NewmoneyPlugin(b3.plugin.Plugin):
    ...
    def onClientSpawn(self, event):
        ...
        if self.rules.respawndisarm is True:
            ...
            fin = open("/home/urt2/urbanterror43/q3ut4/restrictspawn.txt", "rt")
            data = fin.read()
            ...
            fin.close()
            fin = open("/home/urt2/urbanterror43/q3ut4/restrictspawn.txt", "wt")
            fin.write(data)
            fin.close()
        ...
        if client.bot:
            if self.rules.superbots == True:
                ...
                fin = open("/home/urt2/urbanterror43/q3ut4/superbots.txt", "rt")
                data = fin.read()
                data = data.replace('XDATA1', string1)
                data = data.replace('XDATA2', string2)
                data = data.replace('XDATA3', string3)
                ...
                fin.close()
                fin = open("/home/urt2/urbanterror43/q3ut4/superbots.txt", "wt")
                fin.write(data)
                fin.close()
    ...
    def checkRewards(self, client, target):
        ...
        if target.name == target_name:
            ...
            fin = open("/home/urt2/urbanterror43/q3ut4/rewardvampire2.txt", "rt")
            data = fin.read()
            data = data.replace('XDATA1', string1)
            data = data.replace('XDATA2', string2)
            fin.close()
            fin = open("/home/urt2/urbanterror43/q3ut4/rewardvampire2.txt", "wt")
            fin.write(data)
            fin.close()
    ...
    def vampstuff2(self, client):
        if Vampires.vamp1 == client.name:
            ...
            fin = open("/home/urt2/urbanterror43/q3ut4/rewardvampire.txt", "rt")
            data = fin.read()
            data = data.replace('XDATA1', string1)
            data = data.replace('XDATA2', string2)
            fin.close()
            fin = open("/home/urt2/urbanterror43/q3ut4/rewardvampire.txt", "wt")
            fin.write(data)
            fin.close()
