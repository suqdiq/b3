...
class Iourt43Parser(Iourt41Parser):
    ...
    def startup(self):
        ...
        This event is called on every mean of "Exit:" in the logfile, such as
        fraglimit hit or timelimit hit. Mostly used in FFA
        """
        self.Events.createEvent('EVT_GAME_SCOREBOARD', 'Event scoreboard displayed')
    ...
    def OnExit(self, action, data=None, match=None):
