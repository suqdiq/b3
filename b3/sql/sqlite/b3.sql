...
CREATE TABLE IF NOT EXISTS `votedplayers` (
  ...
  `mapname` VARCHAR(512) NOT NULL DEFAULT '0'
);
...
CREATE TABLE IF NOT EXISTS `pbmute` (
  `id` INTEGER PRIMARY KEY AUTOINCREMENT,
  `iduser` INTEGER NOT NULL DEFAULT '0',
  `sname` VARCHAR(512) NOT NULL DEFAULT '0'
);
...
CREATE TABLE IF NOT EXISTS `customauth` (
  `id` INTEGER PRIMARY KEY AUTOINCREMENT,
  `iduser` INTEGER NOT NULL DEFAULT '0',
  `country_short` VARCHAR(32) NOT NULL DEFAULT '0',
  `clan_tag` VARCHAR(32) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `isauthed` (
  `id` INTEGER PRIMARY KEY AUTOINCREMENT,
  `iduser` INTEGER(10) NOT NULL DEFAULT '0'
);
